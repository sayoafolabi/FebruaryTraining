...
public class Helper 
{
	...
	/*########################################################################
	 Implicit wait
	 Wait for Element to be displayed by passing in the element of interest
	##########################################################################*/
	public static void waitForElementToBeDisplayed(WebElement element, int timeOutInSeconds) throws Exception
	{
	...
	/*#########################################################################
	 Implicit wait
	 Wait for Element to be clickable by passing in the element of interest
	###########################################################################*/
	public static void waitForElementToBeClickable(WebElement element, int timeOutInSeconds) throws Exception
	{
		wait = new WebDriverWait(driver, timeOutInSeconds);
	...
	/*#########################################################################
	 Implicit wait
	 Wait for Element to be selectable by passing in the element of interest
	###########################################################################*/
	public static void waitForElementToBeSelected(WebElement element, int timeOutInSeconds) throws Exception
	{
		wait = new WebDriverWait(driver, timeOutInSeconds);
	...
	/*##############################
	 ...
	 ###############################*/
	public static void scrollToTheTopOfPage() throws Exception
	{
	...
	/*##################################
	 ...
	 ###################################*/
	public static void scrollToTheBottomOfPage() throws Exception
	{
		JavascriptExecutor js = (JavascriptExecutor)driver;
		js.executeScript("window.scrollBy(0, 250)", "");
	}
	...
	/*##################################
	 Scroll to an element on a webpage  
	 ###################################*/
	...
	{
		Assert.assertTrue(element + " is not selected", element.isSelected());
	}
	...
	/*##########################################################
	Uses - This method helps to get the text attached to an element of interest
	It takes in any WebElement of interest
	############################################################*/
	public static String getTextAttachedToAnElement(WebElement element) throws Exception
	{
	...
	It takes in any WebElement of interest
	############################################################*/
	public static int getTheNumberOfAListOfElements(List<WebElement> element) throws Exception
	{
		return element.size();
	}
	...
	#################################################################*/
	public static void typeGivenValues(WebElement element, String text) throws Exception
	{
		element.clear();
